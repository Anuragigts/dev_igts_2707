    ...
    <div class="content-wrapper">
       <h3>
          ...
          <ol class="breadcrumb pull-right">
             ...
             <li><a href="<?php echo base_url();?>dmr/dmrUserSearch">Money Transfer</a>
             </li>  
                          
             <li class="active">User Login Verification</li>                 
          </ol>OTP
          <!-- Small text for title-->
          <span class="text-sm hidden-xs">User login verification by OTP</span>
                        ...
                        <div id="dth_tab" role="tabpanel" class="tab-pane active">
                           ...
                           <div class="list-group mb0">
                               <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">Enter OTP for verify your account.</div>

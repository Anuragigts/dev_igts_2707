    ...
    <div class="content-wrapper">
        <h3>
          ...
          <ol class="breadcrumb pull-right">
             ...
             <li class="active">View Flight Reports</li>
          </ol> View Flight Reports
          <!-- Small text for title-->
          <span class="text-sm hidden-xs">For viewing Flight reports</span>
                       ...
                       <tbody>
                           <?php  if(count($view) > 0) {
                               $i   =  1;
                                ...
                                <tr>
                                    <td><?= $i++;?></td>
                                    <td><?php echo $view->IssueDate ;?></td>
                                    <td><?php echo $view->BookedByCusomter ;?></td>
                                    <td><?php echo $view->HermesPNR ;?></td>

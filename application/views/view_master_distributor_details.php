               ...
               <div class="row">
                  <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="text-center text-bold"><a href="javascript:void(0);" class="view_dis" onclick="showSupers(<?= $view->login_id;?>,'<?= $name;?>')" login="<?= $view->login_id;?>" user_name="<?= $name;?>" val-dis="3">View All Super distributors under this <?= $name;?></a></h3>
                                </div>
                            </div>
<!--                           <table id="datatable1" class="table table-striped table-hover table-responsive">
                              ...
                              <tbody>
                                        <tr>
                                            ...
                                            <th>
                                                <a href="javascript:void(0);" class="view_dis" onclick="showSupers(<?= $view->login_id;?>,'<?= $name;?>')" login="<?= $view->login_id;?>" user_name="<?= $name;?>" val-dis="3">View All Super distributors</a>
                                            </th>
                                         </tr>
                              </tbody>
                           </table>-->
                ...
                <!-- END DATATABLE 1 -->
                <!-- START SUPER DISTRIBUTORS -->
                <div class="row">
                    <div class="col-lg-12">
                        <h4><span id="user_val_super"></span></h4>
                     </div>
                </div>
                <div class="" id="txtSuperval">

                </div>
                <!-- END SUPER DISTRIBUTORS -->
                <!-- START DISTRIBUTORS -->
                <div class="row">
                    <div class="col-lg-12">

...
<!--                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <form method="post" action="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class='pull-right checkbox-inline'>Check All</span> <input type='checkbox' value='1'  class='checkapi checkbox-inline pull-right'/>
                                    </div>
                                </div>
                                <div id="accordion">
                                    <?php 
                                       ...
                                       foreach($viw as $re){
                                            if($re->module_id == 1){ ?>
                                                <div class="row padding-3">
                                                    ...
                                                    <div class="col-sm-3 col-xs-3">
                                                        <a href="javascript:void(0);" title="<?php echo ($re->status  == 0)? 'Off':'On';?>">
